...
<ScrollAnimation animateIn="flipInX">
  <div className="project">
    <div className="project-image">
      <img 
        src="https://www.fortjadhavgadh.com/img/about/Home-page-image.webp" 
  ...
  <div className="project">
    <div className="project-image">
      <img 
        src="https://orchidtoyam.com/img/toyam/SparetreatsinPune.webp" 
    ...
    <div className="project-body">
      ...
      <p style={{ margin: "0.5rem 0" }}>
        ...
        I led the project along with two interns—designed and developed the Hero and important pages myself, 
  ...
  <div className="project">
    <div className="project-image">
      <img 
        src="https://orchidresortgoa.com/assets/images/blog/couple-spa-thumbnail.webp" 
...
<ScrollAnimation animateIn="flipInX">
  <div className="project">
    <div className="project-image">
      <img 
        src="https://thefamilyfarmermangaon.com/img/img/aeriel-view-farm_693838-1240.jpg" 
  ...
  <div className="project">
    <div className="project-image">
      <img 
        src="https://kolsite.com/assets/images/company-banner.png" 
...
<ScrollAnimation animateIn="flipInX">
  <div className="project">
    <div className="project-image">
      <img 
        src="https://www.geon-energy.com/wp-content/uploads/2025/05/sustainability-banner.webp" 
...
<ScrollAnimation animateIn="flipInX">
  <div className="project">
    <div className="project-image">
      <img 
        src="https://devop.bcwebwise.com:8081/bcwebwise/bcwebwise-studio/assets/images/5U4A1641%201.png" 
  ...
  <div className="project">
    <div className="project-image">
      <img 
        src="https://www.siwscollege.edu.in/wp-content/uploads/2024/12/home_banner_02.jpg" 
